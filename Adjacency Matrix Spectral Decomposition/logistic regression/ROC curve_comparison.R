...
plot(seq(0,1,0.01),seq(0,1,0.01),type='n',xlab="P(1|0)",ylab="P(1|1)",main="ROC curve")
for (i in 2){
...
#   
  ...
  points(M.ROC.glm[1,],M.ROC.glm[2,],col=1,lwd=2,type="l")
  points(M.ROC.glmnet[1,],M.ROC.glmnet[2,],col=2,lwd=2,type="l")
  points(M.ROC.svm[1,],M.ROC.svm[2,],col=3,lwd=2,type="l")
}
